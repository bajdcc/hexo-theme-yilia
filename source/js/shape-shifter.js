...
var S = {
  ...
  init: function () {
    ...
    //} else {
        $(".canvas").addClass('intro-trans');
        //if (window.innerWidth < 500) {
          //return;//S.UI.simulate($('#intro_mobile').html());
        //} else {
          S.UI.simulate($('#intro_title').html());
        //}
    //}
...
S.ShapeBuilder = (function () {
  var gap = 13,
      ...
      fontSize = 800,
      fontFamily = 'Consolas, Avenir, Helvetica Neue, Helvetica, Arial, sans-serif';
